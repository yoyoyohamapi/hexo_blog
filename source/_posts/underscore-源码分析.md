...
categories: underscore 源码分析

---



> 文章已发布至 [GitBook](https://www.gitbook.com/book/yoyoyohamapi/undersercore-analysis)
...
### [underscore 基础篇](https://yoyoyohamapi.gitbooks.io/undersercore-analysis/content/base/)
...
### [underscore 集合篇](https://yoyoyohamapi.gitbooks.io/undersercore-analysis/content/collection/)

不同于数学当中的集合，在 underscore 中，简单地定义集合为 **一个可迭代的序列**，相较于原生的 ES5 提供的迭代方法，underscore 不仅能够对数组进行迭代，还能够对对象进行迭代。

### [underscore 数组篇](https://yoyoyohamapi.gitbooks.io/undersercore-analysis/content/array/)

这一章节我们将介绍 underscore 中提供的针对数组的操作，部分 API 已经在集合篇中有过阐述，不再赘述。

### [underscore 函数篇](https://yoyoyohamapi.gitbooks.io/undersercore-analysis/content/function/)

在 JavaScript 中，函数是第一型的对象，函数在 JavaScript 中的地位因此可见一斑。这一章节也是我认为最为重要的一章，在本章中，能够见到许多实用的针对函数的操作，以及函数式编程中的重要概念。

### [underscore 对象篇](https://yoyoyohamapi.gitbooks.io/undersercore-analysis/content/object/)

本章中，将介绍 underscore 中操作对象的 API。

### [underscore 实用工具篇](https://yoyoyohamapi.gitbooks.io/undersercore-analysis/content/utils/)

underscore 还提供了不少工具函数，来提供一些周边功能，如字符逃逸等。但其中最重要的是其提供的模板引擎工具，我将会花费很大笔墨对其进行描述。

### [underscore 内容拾遗](https://yoyoyohamapi.gitbooks.io/undersercore-analysis/content/supply/)
